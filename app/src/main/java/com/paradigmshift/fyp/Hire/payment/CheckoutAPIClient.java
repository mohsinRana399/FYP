...
public class CheckoutAPIClient {
    ...
    private com.checkout.android_sdk.CheckoutAPIClient.OnTokenGenerated mTokenListener;
    private com.checkout.android_sdk.CheckoutAPIClient.OnGooglePayTokenGenerated mGooglePayTokenListener;
     ...
     * {@link com.checkout.android_sdk.CheckoutAPIClient.OnTokenGenerated} so you can receive the token back.
     * <p>
    ...
    public CheckoutAPIClient setTokenListener(OnTokenGenerated listener) {
        this.mTokenListener = (com.checkout.android_sdk.CheckoutAPIClient.OnTokenGenerated) listener;
        return this;
    }
    ...
    public CheckoutAPIClient setGooglePayListener(OnGooglePayTokenGenerated listener) {
        this.mGooglePayTokenListener = (com.checkout.android_sdk.CheckoutAPIClient.OnGooglePayTokenGenerated) listener;
        return this;
    }
}
