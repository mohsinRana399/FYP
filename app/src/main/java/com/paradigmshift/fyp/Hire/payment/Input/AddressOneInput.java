package com.paradigmshift.fyp.Hire.payment.Input;
 ...
 */
public class AddressOneInput extends androidx.appcompat.widget.AppCompatEditText {
    ...
    public void setAddressOneListener(AddressOneListener listener) {
